...
CNorAtk_Trail1::CNorAtk_Trail1(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	:CEffect_Mesh(pDevice, pContext)
{
}

CNorAtk_Trail1::CNorAtk_Trail1(const CNorAtk_Trail1 & rhs)
	:CEffect_Mesh(rhs)
{
}

HRESULT CNorAtk_Trail1::Init_Prototype()
{
...
HRESULT CNorAtk_Trail1::Init(void * pArg)
{
...
HRESULT CNorAtk_Trail1::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CNorAtk_Trail1::SetUp_ShaderResources()
{
...
CNorAtk_Trail1 * CNorAtk_Trail1::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CNorAtk_Trail1*		pInstance = new CNorAtk_Trail1(pDevice, pContext);

	if (FAILED(pInstance->Init_Prototype()))
	{
		MSG_BOX("Failed to Created : CNorAtk_Trail1");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CNorAtk_Trail1::Clone(void * pArg)
{
	CNorAtk_Trail1*		pInstance = new CNorAtk_Trail1(*this);

	if (FAILED(pInstance->Init(pArg)))
	{
		MSG_BOX("Failed to Cloned : CNorAtk_Trail1");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CNorAtk_Trail1::Free()
{
	__super::Free();
}
