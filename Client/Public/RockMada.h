...
BEGIN(Client)
class CRockMada final : public CGameObject
{
public:
...
public:
	CRockMada(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	CRockMada(const CRockMada& rhs);
	virtual ~CRockMada() = default;
...
public:
	static CRockMada* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
