...
void CTrollQ::AdditiveAnim(_double TimeDelta)
{
	...
	if (AnimFinishChecker(TROLLQ_ADD_DMG_F, 0.9))
	{
	...
	if (AnimFinishChecker(TROLLQ_ADD_DMG_B, 0.9))
	{
...
HRESULT CTrollQ::SetUP_ShadowShaderResources()
{
	if (nullptr == m_pShaderCom)
		return E_FAIL;
