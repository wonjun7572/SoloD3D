...
HRESULT CRock_1::Init_Prototype()
{
...
HRESULT CRock_1::Init(void * pArg)
{
...
void CRock_1::Late_Tick(_double TimeDelta)
{
...
HRESULT CRock_1::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_CHAP1, TEXT("Rock_1"), TEXT("Com_Model"),
...
CRock_1 * CRock_1::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	...
	{
		MSG_BOX("Failed to Created : CRock_1");
...
CGameObject * CRock_1::Clone(void * pArg)
{
	...
	{
		MSG_BOX("Failed to Cloned : CRock_1");
		Safe_Release(pInstance);
	}
	return pInstance;
}
