...
HRESULT CBelt::SetUp_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_CHAP1, TEXT("Prototype_Component_Model_Belt"), TEXT("Com_Model"),
...
HRESULT CBelt::SetUp_ShaderResources()
{
...
void CBelt::Imgui_RenderProperty()
{
	ImGui::Begin("Upper");
