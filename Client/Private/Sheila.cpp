...
void CSheila::Tick(_double TimeDelta)
{
	...
	//{
	//	m_pTransformCom->Turn(XMVectorSet(0.f, 1.f, 0.f, 0.f), TimeDelta * MouseMove);
	//}

	//if (MouseMove = pGameInstance->Get_DIMouseMove(DIMS_Y))
	//{
	//	m_pTransformCom->Turn(m_pTransformCom->Get_State(CTransform::STATE_RIGHT), TimeDelta * MouseMove);
	//}
