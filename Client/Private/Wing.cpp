...
HRESULT CWing::SetUp_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_CHAP1, TEXT("Wing"), TEXT("Com_Model"),
...
HRESULT CWing::SetUp_ShaderResources()
{
...
CWing * CWing::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	...
	{
		MSG_BOX("Failed to Created : CWing");
...
CGameObject * CWing::Clone(void * pArg)
{
	...
	{
		MSG_BOX("Failed to Cloned : CWing");
		Safe_Release(pInstance);
	}
	return pInstance;
}
