...
CBoomWave_1::CBoomWave_1(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	:CEffect_Mesh(pDevice, pContext)
{
}

CBoomWave_1::CBoomWave_1(const CBoomWave_1 & rhs)
	: CEffect_Mesh(rhs)
{
}

HRESULT CBoomWave_1::Init_Prototype()
{
...
HRESULT CBoomWave_1::Init(void * pArg)
{
...
void CBoomWave_1::Tick(_double TimeDelta)
{
...
void CBoomWave_1::Late_Tick(_double TimeDelta)
{
...
void CBoomWave_1::Imgui_RenderProperty()
{
	__super::Imgui_RenderProperty();
}

HRESULT CBoomWave_1::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_CHAP1, TEXT("BoomWave_1"), TEXT("Com_Model"),
...
HRESULT CBoomWave_1::SetUp_ShaderResources()
{
...
CBoomWave_1 * CBoomWave_1::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CBoomWave_1*		pInstance = new CBoomWave_1(pDevice, pContext);

	if (FAILED(pInstance->Init_Prototype()))
	{
		MSG_BOX("Failed to Created : CBoomWave_1");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CBoomWave_1::Clone(void * pArg)
{
	CBoomWave_1*		pInstance = new CBoomWave_1(*this);

	if (FAILED(pInstance->Init(pArg)))
	{
		MSG_BOX("Failed to Cloned : CBoomWave_1");
		Safe_Release(pInstance);
	}
	return pInstance;
}

void CBoomWave_1::Free()
{
	__super::Free();
}
