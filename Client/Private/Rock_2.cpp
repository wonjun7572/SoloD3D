...
HRESULT CRock_2::Init_Prototype()
{
...
HRESULT CRock_2::Init(void * pArg)
{
...
void CRock_2::Late_Tick(_double TimeDelta)
{
...
HRESULT CRock_2::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_CHAP1, TEXT("Rock_2"), TEXT("Com_Model"),
...
CRock_2 * CRock_2::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	...
	{
		MSG_BOX("Failed to Created : CRock_2");
...
CGameObject * CRock_2::Clone(void * pArg)
{
	...
	{
		MSG_BOX("Failed to Cloned : CRock_2");
		Safe_Release(pInstance);
	}
	return pInstance;
}
