...
CPig::CPig(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
...
HRESULT CPig::Init(void * pArg)
{
	...
	Set_ObjectName(TEXT("Pig"));

	return S_OK;
}

void CPig::Tick(_double TimeDelta)
{
...
void CPig::Imgui_RenderProperty()
{
...
HRESULT CPig::SetUp_ShaderResources()
{
...
CPig * CPig::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CPig*		pInstance = new CPig(pDevice, pContext);

	if (FAILED(pInstance->Init_Prototype()))
	{
		MSG_BOX("Failed to Created : CPig");
