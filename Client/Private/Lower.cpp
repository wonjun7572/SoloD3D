...
HRESULT CLower::SetUp_Components()
{
	...
	/* For.Com_Model */
	if (FAILED(__super::Add_Component(LEVEL_CHAP1, TEXT("Prototype_Component_Model_Lower"), TEXT("Com_Model"),
...
HRESULT CLower::SetUp_ShaderResources()
{
...
void CLower::Imgui_RenderProperty()
{
	ImGui::Begin("Upper");
