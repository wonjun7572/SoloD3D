...
CFireWave::CFireWave(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
	:CEffect_Mesh(pDevice, pContext)
{
}

CFireWave::CFireWave(const CFireWave & rhs)
	: CEffect_Mesh(rhs)
{
}

HRESULT CFireWave::Init_Prototype()
{
...
HRESULT CFireWave::Init(void * pArg)
{
...
void CFireWave::Tick(_double TimeDelta)
{
...
void CFireWave::Late_Tick(_double TimeDelta)
{
...
HRESULT CFireWave::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CFireWave::SetUp_ShaderResources()
{
...
CFireWave * CFireWave::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pContext)
{
	CFireWave*		pInstance = new CFireWave(pDevice, pContext);

	if (FAILED(pInstance->Init_Prototype()))
	{
		MSG_BOX("Failed to Created : CFireWave");
		Safe_Release(pInstance);
	}
	return pInstance;
}

CGameObject * CFireWave::Clone(void * pArg)
{
	CFireWave*		pInstance = new CFireWave(*this);

	if (FAILED(pInstance->Init(pArg)))
	{
		MSG_BOX("Failed to Cloned : CFireWave");
		Safe_Release(pInstance);
	}
	return pInstance;
}
