...
void CFrustum::Transform_ToWorldSpace()
{
	...
	_matrix			ProjMatrixInv =	XMLoadFloat4x4(&pPipeLine->Get_TransformMatrix_Inverse(CPipeLine::D3DTS_PROJ));
	_matrix			ViewMatrixInv = XMLoadFloat4x4(&pPipeLine->Get_TransformMatrix_Inverse(CPipeLine::D3DTS_VIEW));
